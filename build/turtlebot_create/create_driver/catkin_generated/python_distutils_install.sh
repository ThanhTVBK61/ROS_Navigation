...
echo_and_run cd "/home/tranthanh/cafebot_ws/src/turtlebot_create/create_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/tranthanh/cafebot_ws/src/turtlebot_create/create_driver/setup.py" \
    build --build-base "/home/tranthanh/cafebot_ws/build/turtlebot_create/create_driver" \
    install \
    $DESTDIR_ARG \
